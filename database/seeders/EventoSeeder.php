    ...
    public function run(): void
    {
        $eventos = [
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 35, "precio" => 6000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 30, "precio" => 9000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 15, "precio" => 7000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 25, "precio" => 12000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 55, "precio" => 8000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 65, "precio" => 15000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 75, "precio" => 5000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 85, "precio" => 9000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 995, "precio" => 9000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 5, "precio" => 13000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 15, "precio" => 8500, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 25, "precio" => 11000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 25, "precio" => 7000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 25, "precio" => 9500, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 15, "precio" => 8000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 35, "precio" => 12000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 33, "precio" => 9500, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 34, "precio" => 14000, "estado" => "Disponible"]
                ],
            ...
            [
                ...
                "entradas" => [
                    ["tipo" => "General", "cantidad" => 35, "precio" => 10000, "estado" => "Disponible"],
                    ["tipo" => "VIP", "cantidad" => 36, "precio" => 15000, "estado" => "Disponible"]
                ],
